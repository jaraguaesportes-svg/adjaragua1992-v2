...
export const gameSchema = z.object({
  ...
  opponentCoachId: z.string().optional(),
  opponentStarters: z.array(z.string()).optional(),
  opponentSubstitutes: z.array(z.string()).optional(),
  opponentParticipated: z.array(z.string()).optional(),
